...
class DeleteExerciseTest extends ExerciseIntegrationBaseTest {
  ...
  private static final String ENDPOINT = "/exercises-api/exercises/{exerciseId}";
  ...
  void deleteExerciseOk() throws Exception {
    ...
    mockMvc.perform(delete(ENDPOINT, exerciseId)).andDo(print()).andExpect(status().isNoContent());
