...
public class AuthExceptionHandler {
  ...
  @ExceptionHandler({WrongRegisterCodeException.class, UsernameAlreadyExistsException.class})
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  protected ApiError handleRegisterException(final WrongRegisterCodeException ex) {
