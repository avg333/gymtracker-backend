...
import org.avillar.gymtracker.workoutapi.set.infrastructure.get.model.GetSetResponse;
...
public class GetSetController {
  ...
  public ResponseEntity<GetSetResponse> getSet(@PathVariable final UUID setId) {
  ...
  public ResponseEntity<GetSetResponse> getSetDefaultDataForNewSet(
