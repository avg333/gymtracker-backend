...
public enum ErrorCodes {
  ...
  // SET ERROR CODES
  ERR_BF_SET_03("Acceso al org.avillar.gymtracker.workoutapi.set especificado no permitido"),
  ERR_BF_SET_04("El org.avillar.gymtracker.workoutapi.set especificado no existe"),
  ...
  ERR_BF_SETGROUP_10("El setGroup no puede tener session y org.avillar.gymtracker.workoutapi.workout simultaneamente"),
  ERR_BF_SETGROUP_11("El setGroup debe tener una session o un org.avillar.gymtracker.workoutapi.workout"),

  // WORKOUT ERROR CODES
  ERR_BF_WORKOUT_03("Acceso al org.avillar.gymtracker.workoutapi.workout especificado no permitido"),
  ERR_BF_WORKOUT_04("El org.avillar.gymtracker.workoutapi.workout especificado no existe"),
  ERR_BF_WORKOUT_10("Ya existe un org.avillar.gymtracker.workoutapi.workout en esa fecha"),
  ERR_BF_WORKOUT_20("La fecha del org.avillar.gymtracker.workoutapi.workout no es valida"),
