package org.avillar.gymtracker.exercisesapi.musclesubgroup.getallmusclesubgroupsbymusclegroup;
...
class GetAllMuscleSubGroupsByMuscleGroupTest {
  ...
  void getAllMuscleSubGroupsByMuscleGroup() throws Exception {
    ...
    mockMvc
        .perform(get("/exercises-api/muscleGroups/" + muscleGroup.getId() + "/muscleSubGroups"))
        .andDo(print())
